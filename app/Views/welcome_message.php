                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/assets/templated/dist/img/caraosel8.png" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="/assets/templated/dist/img/caraousel4.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="/assets/templated/dist/img/caraosel2.jpg" class="d-block w-100" alt="...">
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-2 col-2">
                    <div class="small-box bg-gradient-primary">
                        ...
                        <a href="http://10.14.150.146/simonev1_management/index.php" target="_blank" class="small-box-footer">SIMONE <i class="fas fa-arrow-circle-right"></i></a>
                ...
                <div class="col-lg-2 col-2">
                    <div class="small-box bg-gradient-primary">
                        ...
                        <a href="https://10.72.35.8/acmt/" target="_blank" class="small-box-footer">ACMT <i class="fas fa-arrow-circle-right"></i></a>
                        <a href="http://10.14.150.147/sip/login" target="_blank" class="small-box-footer">SIP <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-danger">
                        ...
                        <a href="http://10.23.123.118/mancc" target="_blank" class="small-box-footer">MAN CC <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-danger">
                        ...
                        <a href="https://10.23.123.11/agentdesktop" target="_blank" class="small-box-footer">SYSCCA <i class="fas fa-arrow-circle-right"></i></a>
                        <a href="https://10.23.123.11:3033" target="_blank" class="small-box-footer">SYSCCA Cert <i class="fas fa-arrow-circle-right"></i></a>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-danger">
                        ...
                        <a href="https://docs.google.com/spreadsheets/d/1C-7UgROUsNVXS6AM25HFEjNtucFxLinNl1EdWBVjUA4/edit?usp=sharing" target="_blank" class="small-box-footer">Tiket Open Subsektor PLN <i class="fas fa-arrow-circle-right"></i></a>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-danger">
                        ...
                        <a href="https://10.68.35.68/dacen/default/index.php" target="_blank" class="small-box-footer">P2APST PC Genap <i class="fas fa-arrow-circle-right"></i></a>
                        <a href="http://10.70.1.78/dacen/default/index.php" target="_blank" class="small-box-footer">P2APST PC Ganjil <i class="fas fa-arrow-circle-right"></i></a>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-2 col-2">
                            <div class="small-box bg-success">
                                ...
                                <a href="http://10.14.155.18/NiceApplications/Desktop/XbapApplications/NiceDesktop.xbap" target="_blank" class="small-box-footer">NICE <i class="fas fa-arrow-circle-right"></i></a>
                                <a href="https://siujang.esdm.go.id/" target="_blank" class="small-box-footer">SI UJANG <i class="fas fa-arrow-circle-right"></i></a>
                ...
                <div class="row">
                    ...
                    <section class="col-lg-6 connectedSortable">
                        <div class="col">
                            <div class="card shadow">
                                <div class="inner">
                                    <img src="/assets/templated/dist/img/14.jpeg" class="card-img-top" alt="...">
                                    <div class="card-body">
                    ...
                    <section class="col-lg-6 connectedSortable">
                        <div class="col">
                            <div class="card shadow">
                                <div class="inner">
                                    <img src="/assets/templated/dist/img/asqw.jpeg" class="card-img-top" alt="...">
                                    <div class="card-body">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg">
                        <div class="card shadow" style="width: 19rem;">
                            <div class="">
                                <img src="/assets/templated/dist/img/10.jpeg" class="card-img-top" alt="...">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div class="card shadow" style="width: 20rem;">
                            <div class="inner">
                                <video controls>
                                    <source src="/assets/templated/dist/video/vid1.mp4" type="video/mp4">
                                </video>
                            </div>
                    ...
                    <div class="col-lg">
                        <div class="card shadow" style="width: 19rem;">
                            <div class="">
                                <img src="/assets/templated/dist/img/1511.jpeg" class="card-img-top" alt="...">
                            </div>
                        </div>
                    </div>
                    <!-- di -->
...
<script>
    function addTab(title, url) {
        if ($('#tt').tabs('exists', title)) {
            ...
            var content = '<iframe id="frame" scrolling="auto" frameborder="0"  src="' + url + '" style="width:100%;height:100%;"></iframe>';
            $('#tt').tabs('add', {
                title: title,
                content: content,
...
<!-- bootstrap -->
<link rel="stylesheet" href="/assets/templated/dist/css/bootstrap.min.css">
<link rel="stylesheet" href="/assets/templated/dist/css/style.css">
<?= $this->endSection() ?>
