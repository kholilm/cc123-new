                ...
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <div class="row">
                                <iframe src="/assets/file_pdf/<?= $datapdf->path_pdf ?>" style="height:770px;width:1100px;" title="Iframe Example"></iframe>
                            </div>
                        </div>
                    </div>
                    <!-- /.card -->
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-danger">
                                <div class="inner">
                                    <h4>TOOLS CC</h4>
                                    <div class="image">
                                        <img src="/assets/templated/dist/img/cc123.png" alt="Image" height="45" width="45">
                                    </div>
                                    <!-- <br> -->
                                </div>
                                <div class="icon">
